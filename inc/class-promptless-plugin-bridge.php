...
class Promptless_Plugin_Bridge {
     ...
     * @return void
     */
    public static function render_sections( $post_id, $template_label = '' ) {
        ...
        try {
            ...
            if ( ! empty( $collected_css ) ) {
                // CSS is generated by the plugin's SectionRenderer and is
                // already sanitized internally — escaping it here would
                // double-encode. The id attribute IS escaped.
